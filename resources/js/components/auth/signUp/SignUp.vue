                ...
                <v-card class="login-form">
                    ...
                    <div class="form-group">
                        ...
                        <v-text-field
                            ...
                            :error-messages="checkError('repeatPassword')"
                            placeholder="Password"
                            type="password"
                            :single-line="true"
                        />
                    ...
                    <div class="form-group">
                        <button @click.prevent="onRegister" type="submit" class="btn form-control btn-primary rounded submit px-3">Get Started</button>
                    </div>
                </v-card>
